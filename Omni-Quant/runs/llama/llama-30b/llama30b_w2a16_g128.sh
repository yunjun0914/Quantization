...
#SBATCH --job-name=llama30b_w2a16
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
...
python main.py \
    --model ~/Quantization/Omni-Quant/OmniQuant/models/llama-30b \
    --net llama-30b \
    --epochs 40 \
    --output_dir ./log/llama-30b-w2a16 \
    --eval_ppl \
    --wbits 2 \
    --abits 16 \
    --group_size 128 \
    --lwc \
    --act-scales ./act_scales/llama-30b.pt \
    --act-shifts ./act_shifts/llama-30b.pt \
    --save_dir ./output/llama30b_w2a16
