...
def llama_rot_sequential_v2(
    ...
    rot_mode="hadamard", seed=0, use_u=True, v1_mode=False, use_2d_vq=False,
):
    ...
    for layer_idx, layer in enumerate(layers):
        ...
        handlers = {
            name: RotatedGPTQ(lin, *rotations[name], restore_u=(not v1_mode), use_2d_vq=use_2d_vq)
...
def run_llama_rot_v2(
    ...
    dev="cuda:0", eval_before=True, use_u=True, v1_mode=False, use_2d_vq=False,
):
    ...
    results, U_gu = llama_rot_sequential_v2(
        ...
        bits=bits, blocksize=blocksize, percdamp=percdamp,
        groupsize=groupsize, sym=sym, actorder=actorder,
        rot_mode=rot_mode, seed=seed, use_u=use_u, v1_mode=v1_mode, use_2d_vq=use_2d_vq,
    )
